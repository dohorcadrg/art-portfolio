class Header extends HTMLElement {
  connectedCallback() {
    ...
    <button class="btn" type="button" style="border: 1px solid #d84c9b; color: #d84c9b;" data-bs-toggle="collapse" data-bs-target="#collapseHeader" aria-expanded="false" aria-controls="collapseHeader">
      <i class="fa-solid fa-bars"></i>
    </button>
        <div class="row collapse" id="collapseHeader" style="width: 100%; padding: 10px; border-top: 1px solid #e68bbe; margin: 0px;color: #d84c9b">
          ...
          <div class="container" style=" margin-top: 10px;">
            ...
            <a href="https://api.whatsapp.com/send?phone=16707884928&text=I%27m%20interested%20in%20your%20art"><button class="btn" type="button" style="border: 1px solid #dc228b; color:#dc228b;">WhatsApp</button></a>
            </div>
            </div>
          </div>
        </div>
...
class BannerText extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
    <span style="color: white;text-shadow: 1px 1px 2px black, 0 0 25px #e68bbe;"><br><br><br><H1 class="display-4">Glory's Art Portfolio</H1><p class="lead">Welcome to my art</p><br><br><br></span>
    `;
  }
}
